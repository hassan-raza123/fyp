...
export default function SuperAdminOverviewPage() {
      ...
      try {
        ...
        if (adminsRes.ok) {
          ...
          if (adminsJson.success) {
            const formatted = adminsJson.data.map((admin: any) => ({
              id: admin.userId,
              userId: admin.userId,
        ...
        toast.error('Failed to load super admin overview');
      } finally {
        setLoading(false);
      }
    };
  ...
  const assignedDepartments = departments.filter((d) => d.admin).length;
  const unassignedDepartments = departments.filter((d) => !d.admin).length;
    ...
    <div className="container mx-auto py-10 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">{assignedDepartments}</div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">{unassignedDepartments}</div>
          </CardContent>
        </Card>
      </div>

      {/* Quick department preview */}
      <Card>
        <CardHeader>
