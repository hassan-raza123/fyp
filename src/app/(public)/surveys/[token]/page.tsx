  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-surface-2">
        <div className="text-ink-muted text-lg">Loading survey...</div>
      </div>
    );
  }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-subtle rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </div>
              <div>
            ...
            <div key={q.id} className="bg-surface rounded-xl shadow p-6">
              ...
              {q.questionType === 'rating' ? (
                <div className="flex gap-2 flex-wrap">
                  ...
                  <div className="w-full flex justify-between text-xs text-ink-muted mt-1">
                    <span>Poor</span>
                    <span>Excellent</span>
                  </div>
                </div>
                ...
                <textarea
                  ...
                  className="w-full border border-subtle rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary resize-none"
                />
              )}
            </div>
          ))}
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-primary hover:bg-primary text-white font-semibold py-3 rounded-xl transition-colors disabled:opacity-50"
          >
