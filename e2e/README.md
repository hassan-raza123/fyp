...
A separate database, configured by `DATABASE_URL` in `.env.test`. Your
...
```bash
mysql -u root -p -e "CREATE DATABASE <name from .env.test> CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
